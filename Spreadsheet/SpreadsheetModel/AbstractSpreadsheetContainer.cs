...
namespace SpreadsheetModel
{
    ...
    /// dependency.
    /// </summary>
    public abstract class AbstractSpreadsheetContainer
    {
        // ADDED FOR PS5
        /// <summary>
        ...
        /// equal.
        /// </summary>
        public AbstractSpreadsheetContainer(Func<string, bool> isValid, Func<string, string> normalize, string version)
        {
        ...
        protected IEnumerable<String> GetCellsToRecalculate(ISet<String> names)
        {
            ...
            foreach (string name in names.Where(name => !visited.Contains(name)))
